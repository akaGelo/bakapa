...
public class BackupsTargetsOnAgentPrivateApiController extends SuperPrivateController {
    ...
    public AbstractBackupTarget updateBackupTarget(@ModelAttribute("agent") Agent agent,
        ...
        AbstractBackupTarget abstractBackupTarget = backupsTargetsService.updateBackupTarget(backupTarget);
        backupSchedulerService.update(abstractBackupTarget);
        return abstractBackupTarget;
    }
